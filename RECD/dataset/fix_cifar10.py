...
def get_cifar10(root, l_samples, u_samples, transform_train=transform_train, transform_strong=transform_strong,
    ...
    train_labeled_idxs, train_unlabeled_idxs, train_only_unlabeled_idxs= train_split(base_dataset.targets, l_samples, u_samples)
...
def train_split(labels, n_labeled_per_class, n_unlabeled_per_class):
    ...
    for i in range(10):
        ...
        train_only_unlabeled_idxs.extend(idxs[n_labeled_per_class[i]:n_labeled_per_class[i] + n_unlabeled_per_class[i]])

    return train_labeled_idxs, train_unlabeled_idxs, train_only_unlabeled_idxs
